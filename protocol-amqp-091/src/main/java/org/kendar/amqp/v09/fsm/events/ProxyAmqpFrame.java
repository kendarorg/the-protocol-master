...
public class ProxyAmqpFrame extends BaseEvent implements TaggedObject {
    private final BBuffer buffer;
    private final short channel;

    public ProxyAmqpFrame(ProtoContext context, Class<?> prevState, BBuffer buffer, short channel) {
