...
public class AsynchronousServerPlainSocketChannel implements AbstractAsynchronousServerSocketChannel{
    private final AsynchronousServerSocketChannel wrapped;

    public AsynchronousServerPlainSocketChannel(AsynchronousServerSocketChannel wrapped){
