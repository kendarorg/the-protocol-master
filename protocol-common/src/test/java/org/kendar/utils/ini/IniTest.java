...
/**
 * Adapted from https://github.com/vincentrussell/java-ini-parser
 */
public class IniTest {
    ...
    private Map<String, String> getModifiableEnv() throws Exception {
        ...
        var field = unmodifiableEnv.getClass().getDeclaredField("m");
        field.setAccessible(true);
        return (Map<String, String>) field.get(unmodifiableEnv);
    }

    @Test
    public void variableInterpolationInIniFile() throws Exception {
        Ini ini = new Ini();
        try {
            setEnv("ENV_VAR1", "this is an environment variable");
