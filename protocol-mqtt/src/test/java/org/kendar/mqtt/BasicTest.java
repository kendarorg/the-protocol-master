    ...
    public static void beforeEachBase(TestInfo testInfo) {
        ...
        if (testInfo != null && testInfo.getTestClass().isPresent() &&
            ...
            if (testInfo.getDisplayName().startsWith("[")) {
                ...
                proxy.setStorage(new MqttStorageHandler(new FileStorageRepository<>(Path.of("target", "tests", className, method, dsp))));
            } else {
                proxy.setStorage(new MqttStorageHandler(new FileStorageRepository<>(Path.of("target", "tests", className, method))));
            }
        }
