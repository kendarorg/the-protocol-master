...
public class ProxyResp3Message extends BaseEvent implements TaggedObject, NetworkReturnMessage {
    private static final Resp3Parser parser = new Resp3Parser();
    private static final Logger log = LoggerFactory.getLogger(ProxyResp3Message.class);
    private final Object data;
    private final String message;

    public ProxyResp3Message(ProtoContext context, Class<?> prevState, JsonNode data) {
    ...
    public ProxyResp3Message(ProtoContext context, Class<?> prevState, Object data, String message) {
        super(context, prevState);
        this.data = data;
