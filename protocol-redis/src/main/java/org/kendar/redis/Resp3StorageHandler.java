...
public class Resp3StorageHandler extends BaseStorage<JsonNode, JsonNode> implements Resp3Storage {
    private static final Logger log = LoggerFactory.getLogger(Resp3StorageHandler.class);

    public Resp3StorageHandler(StorageRepository<JsonNode, JsonNode> repository) {
        super(repository);
    }
