...
public class RestPluginsApis implements ProtocolApiHandler {
    private final JsonMapper mapper;
    private final DnsProtocol protocol;
    private final DnsProtocolSettings settings;

    public RestPluginsApis(JsonMapper mapper, DnsProtocol protocol, DnsProtocolSettings settings) {
        this.mapper = mapper;
