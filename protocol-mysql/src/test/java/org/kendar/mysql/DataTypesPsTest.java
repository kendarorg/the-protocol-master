...
public class DataTypesPsTest extends MySqlBasicTest {
    @BeforeAll
    ...
    private static Object getValue(String functionName, ResultSet result, PreparedStatement pstmt) throws IllegalAccessException, InvocationTargetException, SQLException, ClassNotFoundException {
        var mto = Arrays.stream(result.getClass().getMethods()).
    ...
    void createInsertSelectTest(String fullType,
        ...
        var estmt = c.prepareStatement("SELECT * FROM DTT_" + nameType);
        var result = estmt.executeQuery();
