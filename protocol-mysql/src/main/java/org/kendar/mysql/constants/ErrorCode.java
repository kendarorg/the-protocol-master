...
public enum ErrorCode {
    ...
    ERR_NOT_SUPPORTED(3010),
    ERR_MULTI_NODE_FAILED(3011),
    ERR_WRONG_USED(3012),
    ERR_FOUND_EXCEPION(3344),
    // mysql error code
    ER_HASHCHK(1000),
    ER_NISAMCHK(1001),
    ER_NO(1002),
    ...
    ER_USER_READ_ONLY(1495);
    private static final Map<Integer, ErrorCode> BY_INT = new HashMap<>();
    ...
    public static ErrorCode of(int value) {
