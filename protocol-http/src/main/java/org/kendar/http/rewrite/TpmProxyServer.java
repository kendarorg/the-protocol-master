...
public class TpmProxyServer {
    protected static final Logger logger = LoggerFactory.getLogger(TpmProxyServer.class);
    ...
    private TpmProxyHandler handler;
    private int pageCount = 1;
    private List<String> forbiddenUrls = new ArrayList<>(List.of(
            "https://sb-ssl.google.com:443/safebrowsing",
    ...
    private CustomResponderInterceptor responderInterceptor;


    public TpmProxyServer() {
    }

    public TpmProxyServer(final int port) {
        this.port = port;
    }
    ...
    public static void setResponseVolatile(Boolean responseVolatile) {
        TpmProxyServer.responseVolatile = responseVolatile;
    }
    ...
    public static void setShouldKeepSslConnectionAlive(Boolean shouldKeepSslConnectionAlive) {
        TpmProxyServer.shouldKeepSslConnectionAlive = shouldKeepSslConnectionAlive;
    }

    public void addForbiddenUrl(String forbiddenUrl) {
        this.forbiddenUrls.add(forbiddenUrl);
    }
    ...
    public void start(final int requestTimeOut) throws Exception {
        ...
        handler = new TpmProxyHandler();
        handler.setResponderInterceptor(responderInterceptor);
        handler.setForbiddenUrls(forbiddenUrls);
    ...
    public void addResponderInterceptor(CustomResponderInterceptor interceptor) {
       this.responderInterceptor = interceptor;
    }
